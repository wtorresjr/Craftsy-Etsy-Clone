        ...
        review_info = {
            ...
            "Product": {
                ...
                "preview_image_url": [
                    ...
                    for product_img in review.products.product_images
...
def get_curr_user_favorites():
    ...
    for favorite in current_user_favorites:
        ...
        if favorite and favorite.products and favorite.products.quantity == 0:
    ...
    for favorite in current_user_favorites:
        about_favorite = {
            ...
            "preview_image_url": [
                product_img.image_url
                for product_img in favorite.products.product_images
                if product_img.preview == True
            ],
        }
...
def add_to_favorites():
    ...
    find_product = Product.query.filter_by(id=data.get("product_id"))
    ...
    if find_product:
        ...
        new_favorite = Favorite(
            product_id=data.get("product_id"), user_id=current_user.id
        )
